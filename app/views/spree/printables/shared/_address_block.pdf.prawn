...
pdf.move_down 2
address_cell_billing  = pdf.make_cell(content: I18n.t('spree.billing_address', scope: :print_invoice, font_style: :bold)
address_cell_shipping = pdf.make_cell(content: I18n.t('spree.shipping_address', scope: :print_invoice, font_style: :bold)
...
shipping << "\n#{ship_address.phone}"
shipping << "\n\n#{I18n.t('spree.via', scope: :print_invoice)} #{printable.shipping_methods.join(", ")}"
